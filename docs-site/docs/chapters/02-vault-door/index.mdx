...
adb shell cat /data/data/com.fortknox.app/shared_prefs/FlutterSharedPreferences.xml
```
...
class SecureTokenStorage {
  static const _accessTokenKey = 'fortknox_access_token';
  static const _refreshTokenKey = 'fortknox_refresh_token';
  static const _tokenExpiryKey = 'fortknox_token_expiry';
