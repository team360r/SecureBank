...
Build SecureBank in release mode without obfuscation and examine what ships to users:
...
| String literals | `https://api.securebank.example.com/v1` | Exposes API endpoints |
