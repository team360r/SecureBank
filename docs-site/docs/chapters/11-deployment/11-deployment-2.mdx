...
Future<void> main() async {
  ...
  if (kReleaseMode) {
    ...
    if (await IntegrityChecks.isRooted) {
      ...
      // or refuse to run. FortKnox takes a hard line:
      exit(1);
    }
  }
  // highlight-end
...
sequenceDiagram
    ...
    participant Backend as FortKnox Backend
...
Over eleven chapters, you have transformed FortKnox from a deliberately vulnerable banking prototype into a hardened application:
